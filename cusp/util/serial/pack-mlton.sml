...
structure PackInt16L = 
   BasisPackInt(structure Pack = Unsafe.PackWord16Little
                structure Integer = Int16)
structure PackInt32L =
   BasisPackInt(structure Pack = Unsafe.PackWord32Little
                structure Integer = Int32)
structure PackInt64L = 
   BasisPackInt(structure Pack = Unsafe.PackWord64Little
                structure Integer = Int64)

structure PackInt16B = 
   BasisPackInt(structure Pack = Unsafe.PackWord16Big
                structure Integer = Int16)
structure PackInt32B =
   BasisPackInt(structure Pack = Unsafe.PackWord32Big
                structure Integer = Int32)
structure PackInt64B = 
   BasisPackInt(structure Pack = Unsafe.PackWord64Big
                structure Integer = Int64)
